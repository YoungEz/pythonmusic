...
client = Bot(description="DarkBot Bot is best", command_prefix="t!", pm_help = True)
client.remove_command('help')


async def status_task():
    while True:
        await client.change_presence(game=discord.Game(name='for t!help'))
...
client.run(os.getenv('NTEyNjk1MzI1NjU2NDgxODA2.DwK9CA.O2ZCvtcdaLDwBDL8_S2FbMJcgpg'))
