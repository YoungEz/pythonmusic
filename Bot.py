...
async def dance(ctx, user: discord.User):
	...
	hugemb.set_image(url=hug)
	hugemb.set_footer(text ='Comando realizado o por: {} | Shiryu Bot Oficial'.format(ctx.message.author.name))
	await bot.say(embed=hugemb)
...
async def voicemute(ctx, member: discord.Member):
    ...
    emb.set_footer(text ='Comando realizado por: {} | Shiryu Bot Oficial'.format(ctx.message.author.name))
    await bot.say(embed=emb)  
...
async def kick(ctx, userName: discord.User):
	...
	embed.set_footer(text='comando realizado por {} | Bot Oficial Shiryu Bot'.format(ctx.message.author.name))
	await bot.say(embed=embed)
