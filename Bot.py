...
async def serverinfo(ctx):
    embed = discord.Embed(name="{}'s info".format(ctx.message.server.name), description="Esse é seu perfil seu Platina de merda.", color=0x00ff00)
...
async def ping(ctx):
	    ...
	    await bot.edit_message(t, new_content='meu ping é: {}'.format(int(ms)))          
