...
url = 'mongodb+srv://admin:shiryu@tutorial-7xzyj.mongodb.net/test?retryWrites=true&w=majority'
...
bot.run('NTM5NDY4MTU3MjkxODU1OTAz.XO7xJw.oYMMo9MdBw88bHOuPyEIfNTrSzs')
